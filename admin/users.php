...
$total_result = num_rows(query("SELECT u.*, r.nama_role FROM users u JOIN roles r ON u.role_id = r.id"));
$total_pages = ceil($total_result / $limit);

// Get all users with pagination
$users = query("SELECT u.*, r.nama_role FROM users u JOIN roles r ON u.role_id = r.id ORDER BY u.id DESC LIMIT $start, $limit");
                ...
                <div class="card-footer bg-white py-3 px-4 border-top">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <select class="form-select form-select-sm rounded-pill" style="width: 80px;" onchange="window.location.href='users.php?per_page='+this.value+'&page=1'">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-sm mb-0">
                                    <?php if($page > 1): ?>
                                    <li class="page-item">
                                        <a class="page-link rounded-pill me-1" href="users.php?page=<?php echo $page-1; ?>&per_page=<?php echo $limit; ?>">
                                    ...
                                    <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                        <a class="page-link rounded-pill me-1" href="users.php?page=<?php echo $i; ?>&per_page=<?php echo $limit; ?>"><?php echo $i; ?></a>
                                    </li>
                                    <?php endfor; ?>
                                    
                                    <?php if($page < $total_pages): ?>
                                    <li class="page-item">
                                        <a class="page-link rounded-pill" href="users.php?page=<?php echo $page+1; ?>&per_page=<?php echo $limit; ?>">
