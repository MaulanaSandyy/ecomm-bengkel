...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $where .= " AND (u.nama_lengkap LIKE '%$search%' OR j.nama_jasa LIKE '%$search%')";
}
...
$total_result = num_rows(query("SELECT b.* FROM booking b JOIN users u ON b.user_id = u.id LEFT JOIN jasa j ON b.jasa_id = j.id LEFT JOIN service s ON b.id = s.booking_id WHERE $where"));
...
$bookings = query("SELECT b.*, u.nama_lengkap, u.no_hp, j.nama_jasa, j.harga,
                  ...
                  WHERE $where
                  ORDER BY b.created_at DESC LIMIT $start, $limit");
                        ...
                        <div class="card-footer bg-white py-3 px-4 border-top">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <select class="form-select form-select-sm rounded-pill" style="width: 80px;" onchange="window.location.href='booking.php?per_page='+this.value+'&page=1<?php echo isset($_GET['filter_status']) ? '&filter_status=' . $_GET['filter_status'] : ''; ?><?php echo isset($_GET['search']) ? '&search=' . $_GET['search'] : ''; ?>'">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination pagination-sm mb-0">
                                            <?php if($page > 1): ?>
                                            <li class="page-item">
                                                <a class="page-link rounded-pill me-1" href="booking.php?page=<?php echo $page-1; ?>&per_page=<?php echo $limit; ?><?php echo isset($_GET['filter_status']) ? '&filter_status=' . $_GET['filter_status'] : ''; ?><?php echo isset($_GET['search']) ? '&search=' . $_GET['search'] : ''; ?>">
                                            ...
                                            <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                                <a class="page-link rounded-pill me-1" href="booking.php?page=<?php echo $i; ?>&per_page=<?php echo $limit; ?><?php echo isset($_GET['filter_status']) ? '&filter_status=' . $_GET['filter_status'] : ''; ?><?php echo isset($_GET['search']) ? '&search=' . $_GET['search'] : ''; ?>"><?php echo $i; ?></a>
                                            </li>
                                            <?php endfor; ?>
                                            
                                            <?php if($page < $total_pages): ?>
                                            <li class="page-item">
                                                <a class="page-link rounded-pill" href="booking.php?page=<?php echo $page+1; ?>&per_page=<?php echo $limit; ?><?php echo isset($_GET['filter_status']) ? '&filter_status=' . $_GET['filter_status'] : ''; ?><?php echo isset($_GET['search']) ? '&search=' . $_GET['search'] : ''; ?>">
